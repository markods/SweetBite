...
<body class="d-flex flex-column">
    ...
    <div id="navbar" class="nav navbar-nav noselect">
        <div id="navbar-content" class="col-12 offset-sm-2 col-sm-8 offset-lg-3 col-lg-6 d-inline-flex">
            ...
            <!-- text and logo -->
            <div class="brand">
                <a href="#">Slatki zalogaj<img id="logo" src=<?php echo base_url("assets/logo.png"); ?> alt="logo"></a>
            </div>
            ...
            <div id="register" class="btn-group">
                ...
                <form class="dropdown-menu dropdown-menu-right p-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="register-phone-num" placeholder="+381 01 234 5678">
                    </div>
                    <div class="form-group">
                    ...
                    <div>
                        <div class="spacer"></div>
                        <button id="register-button" class="btn btn-success" style="float: right;">prijava</button>
                    </div>
                </form>
            ...
            <!-- logout -->
            <div>
                <button class="btn btn-success p-1">Izloguj me</button>
            </div>

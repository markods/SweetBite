...
//        id++;
    ...
    str+='<div class = "row" style = "background-color:lightblue;" >';
    str+='<div class = "col-sm-12 text-left" style="overflow: hidden;">';
    str+='<textarea draggable="false" style = "margin-bottom:4px; resize: none; " name="opis_jela_temp" form="menjanje_jela_temp" placeholder = "'+object.opis+'" rows = "8" cols="35" ></textarea>';
    str+='</div>';
    str+='</div>' ;
    str+='<div class = "row" style = "background-color:lightblue;">';
    str+='<div class = "col-sm-12 text-right" style = "margin-bottom:4px">';
